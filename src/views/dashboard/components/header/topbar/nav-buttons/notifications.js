const Notifications = () => {
  return (
    <>
      ...
      <div
        className="z-20 z-50 hidden max-w-sm my-4 ease-out duration-300 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700"
